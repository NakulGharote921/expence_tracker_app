            ...
            <div className="w-full max-w-md relative">
                ...
                <div className="bg-white border border-[#141414] shadow-[6px_6px_0px_0px_#F27D26] p-6 sm:p-8">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full border border-[#141414] py-3 flex items-center justify-center gap-2 text-[11px] font-mono uppercase tracking-widest font-bold hover:bg-[#141414] hover:text-white transition-all cursor-pointer disabled:opacity-50"
                    >
